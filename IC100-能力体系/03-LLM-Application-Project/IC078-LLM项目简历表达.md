...
### A1. [repeated-dna-sequences](https://leetcode.com/problems/repeated-dna-sequences/)
...
### A2. [house-robber](https://leetcode.com/problems/house-robber/)
...
围绕 RAG Knowledge Assistant，完成「LLM项目简历表达」阶段，保留文档、检索、回答和评估证据。
...
> 我在 `LLM Application Project` 中完成 `LLM项目简历表达` 阶段，能把知识点转化为可运行代码、可复现输出和可解释复盘。
