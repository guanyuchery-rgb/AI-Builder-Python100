...
### A1. [search-a-2d-matrix](https://leetcode.com/problems/search-a-2d-matrix/)
...
### A2. [sort-colors](https://leetcode.com/problems/sort-colors/)
...
围绕 RAG Knowledge Assistant，完成「文档数据集构造」阶段，保留文档、检索、回答和评估证据。
...
> 我在 `LLM Application Project` 中完成 `文档数据集构造` 阶段，能把知识点转化为可运行代码、可复现输出和可解释复盘。
