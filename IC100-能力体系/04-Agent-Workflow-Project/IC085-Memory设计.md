...
### A1. [lowest-common-ancestor-of-a-binary-tree](https://leetcode.com/problems/lowest-common-ancestor-of-a-binary-tree/)
...
### A2. [game-of-life](https://leetcode.com/problems/game-of-life/)
...
围绕 Agent Workflow System，完成「Memory设计」阶段，所有工具调用、状态变化和人工审查都要可追踪。
...
> 我在 `Agent Workflow Project` 中完成 `Memory设计` 阶段，能把知识点转化为可运行代码、可复现输出和可解释复盘。
