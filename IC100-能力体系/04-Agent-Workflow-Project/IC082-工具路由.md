...
### A1. [house-robber-ii](https://leetcode.com/problems/house-robber-ii/)
...
### A2. [kth-largest-element-in-an-array](https://leetcode.com/problems/kth-largest-element-in-an-array/)
...
围绕 Agent Workflow System，完成「工具路由」阶段，所有工具调用、状态变化和人工审查都要可追踪。
...
> 我在 `Agent Workflow Project` 中完成 `工具路由` 阶段，能把知识点转化为可运行代码、可复现输出和可解释复盘。
