...
### A1. [subarray-sum-equals-k](https://leetcode.com/problems/subarray-sum-equals-k/)
...
### A2. [shortest-unsorted-continuous-subarray](https://leetcode.com/problems/shortest-unsorted-continuous-subarray/)
...
围绕 Agent Workflow System，完成「文件工具与安全边界」阶段，所有工具调用、状态变化和人工审查都要可追踪。
...
> 我在 `Agent Workflow Project` 中完成 `文件工具与安全边界` 阶段，能把知识点转化为可运行代码、可复现输出和可解释复盘。
