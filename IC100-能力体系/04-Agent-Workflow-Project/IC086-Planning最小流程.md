...
### A1. [word-pattern-ii](https://leetcode.com/problems/word-pattern-ii/)
...
### A2. [increasing-triplet-subsequence](https://leetcode.com/problems/increasing-triplet-subsequence/)
...
围绕 Agent Workflow System，完成「Planning最小流程」阶段，所有工具调用、状态变化和人工审查都要可追踪。
...
> 我在 `Agent Workflow Project` 中完成 `Planning最小流程` 阶段，能把知识点转化为可运行代码、可复现输出和可解释复盘。
