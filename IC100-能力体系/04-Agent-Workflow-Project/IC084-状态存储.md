...
### A1. [search-a-2d-matrix-ii](https://leetcode.com/problems/search-a-2d-matrix-ii/)
...
### A2. [perfect-squares](https://leetcode.com/problems/perfect-squares/)
...
围绕 Agent Workflow System，完成「状态存储」阶段，所有工具调用、状态变化和人工审查都要可追踪。
...
> 我在 `Agent Workflow Project` 中完成 `状态存储` 阶段，能把知识点转化为可运行代码、可复现输出和可解释复盘。
