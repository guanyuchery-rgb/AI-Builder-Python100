...
### A1. [counting-bits](https://leetcode.com/problems/counting-bits/)
...
### A2. [intersection-of-two-arrays](https://leetcode.com/problems/intersection-of-two-arrays/)
...
围绕电商用户行为分析，完成「NumPy向量化指标」阶段，让数据从原始文件逐步走向报告和 Dashboard。
...
> 我在 `Data Analysis Project` 中完成 `NumPy向量化指标` 阶段，能把知识点转化为可运行代码、可复现输出和可解释复盘。
