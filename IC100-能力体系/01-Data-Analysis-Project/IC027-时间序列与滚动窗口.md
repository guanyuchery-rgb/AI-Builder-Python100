...
### A1. [range-sum-query-immutable](https://leetcode.com/problems/range-sum-query-immutable/)
...
### A2. [power-of-three](https://leetcode.com/problems/power-of-three/)
...
围绕电商用户行为分析，完成「时间序列与滚动窗口」阶段，让数据从原始文件逐步走向报告和 Dashboard。
...
> 我在 `Data Analysis Project` 中完成 `时间序列与滚动窗口` 阶段，能把知识点转化为可运行代码、可复现输出和可解释复盘。
