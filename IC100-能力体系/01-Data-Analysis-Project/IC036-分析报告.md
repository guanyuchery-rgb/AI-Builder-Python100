...
### A1. [max-consecutive-ones](https://leetcode.com/problems/max-consecutive-ones/)
...
### A2. [construct-the-rectangle](https://leetcode.com/problems/construct-the-rectangle/)
...
围绕电商用户行为分析，完成「分析报告」阶段，让数据从原始文件逐步走向报告和 Dashboard。
...
> 我在 `Data Analysis Project` 中完成 `分析报告` 阶段，能把知识点转化为可运行代码、可复现输出和可解释复盘。
