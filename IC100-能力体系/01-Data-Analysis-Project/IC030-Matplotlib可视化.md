...
### A1. [reverse-vowels-of-a-string](https://leetcode.com/problems/reverse-vowels-of-a-string/)
...
### A2. [first-unique-character-in-a-string](https://leetcode.com/problems/first-unique-character-in-a-string/)
...
围绕电商用户行为分析，完成「Matplotlib可视化」阶段，让数据从原始文件逐步走向报告和 Dashboard。
...
> 我在 `Data Analysis Project` 中完成 `Matplotlib可视化` 阶段，能把知识点转化为可运行代码、可复现输出和可解释复盘。
