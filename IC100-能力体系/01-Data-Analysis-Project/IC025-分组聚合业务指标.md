...
### A1. [valid-anagram](https://leetcode.com/problems/valid-anagram/)
...
### A2. [missing-number](https://leetcode.com/problems/missing-number/)
...
围绕电商用户行为分析，完成「分组聚合业务指标」阶段，让数据从原始文件逐步走向报告和 Dashboard。
...
> 我在 `Data Analysis Project` 中完成 `分组聚合业务指标` 阶段，能把知识点转化为可运行代码、可复现输出和可解释复盘。
