...
### A1. [next-greater-element-i](https://leetcode.com/problems/next-greater-element-i/)
...
### A2. [keyboard-row](https://leetcode.com/problems/keyboard-row/)
...
围绕电商用户行为分析，完成「复现脚本」阶段，让数据从原始文件逐步走向报告和 Dashboard。
...
> 我在 `Data Analysis Project` 中完成 `复现脚本` 阶段，能把知识点转化为可运行代码、可复现输出和可解释复盘。
