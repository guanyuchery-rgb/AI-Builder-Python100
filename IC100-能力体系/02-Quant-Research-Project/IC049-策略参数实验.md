...
### A1. [integer-to-roman](https://leetcode.com/problems/integer-to-roman/)
...
### A2. [3sum](https://leetcode.com/problems/3sum/)
...
围绕 Mini Quant Research Framework，完成「策略参数实验」阶段，所有指标都要能复现并解释风险。
...
> 我在 `Quant Research Project` 中完成 `策略参数实验` 阶段，能把知识点转化为可运行代码、可复现输出和可解释复盘。
