...
### A1. [reverse-words-in-a-string-iii](https://leetcode.com/problems/reverse-words-in-a-string-iii/)
...
### A2. [reshape-the-matrix](https://leetcode.com/problems/reshape-the-matrix/)
...
围绕 Mini Quant Research Framework，完成「价格数据清洗」阶段，所有指标都要能复现并解释风险。
...
> 我在 `Quant Research Project` 中完成 `价格数据清洗` 阶段，能把知识点转化为可运行代码、可复现输出和可解释复盘。
