...
### A1. [jump-game](https://leetcode.com/problems/jump-game/)
...
### A2. [merge-intervals](https://leetcode.com/problems/merge-intervals/)
...
围绕 Mini Quant Research Framework，完成「Quant项目总交付」阶段，所有指标都要能复现并解释风险。
...
> 我在 `Quant Research Project` 中完成 `Quant项目总交付` 阶段，能把知识点转化为可运行代码、可复现输出和可解释复盘。
