...
### A1. [4sum](https://leetcode.com/problems/4sum/)
...
### A2. [remove-nth-node-from-end-of-list](https://leetcode.com/problems/remove-nth-node-from-end-of-list/)
...
围绕 Mini Quant Research Framework，完成「事件研究」阶段，所有指标都要能复现并解释风险。
...
> 我在 `Quant Research Project` 中完成 `事件研究` 阶段，能把知识点转化为可运行代码、可复现输出和可解释复盘。
