...
### A1. [set-mismatch](https://leetcode.com/problems/set-mismatch/)
...
### A2. [two-sum-iv-input-is-a-bst](https://leetcode.com/problems/two-sum-iv-input-is-a-bst/)
...
围绕 Mini Quant Research Framework，完成「Sharpe与风险指标」阶段，所有指标都要能复现并解释风险。
...
> 我在 `Quant Research Project` 中完成 `Sharpe与风险指标` 阶段，能把知识点转化为可运行代码、可复现输出和可解释复盘。
