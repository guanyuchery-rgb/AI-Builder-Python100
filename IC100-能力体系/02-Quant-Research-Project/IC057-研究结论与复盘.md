...
### A1. [powx-n](https://leetcode.com/problems/powx-n/)
...
### A2. [spiral-matrix](https://leetcode.com/problems/spiral-matrix/)
...
围绕 Mini Quant Research Framework，完成「研究结论与复盘」阶段，所有指标都要能复现并解释风险。
...
> 我在 `Quant Research Project` 中完成 `研究结论与复盘` 阶段，能把知识点转化为可运行代码、可复现输出和可解释复盘。
