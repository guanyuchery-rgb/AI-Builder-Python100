...
### A1. [insert-interval](https://leetcode.com/problems/insert-interval/)
...
### A2. [unique-paths](https://leetcode.com/problems/unique-paths/)
...
围绕 Mini Quant Research Framework，完成「Quant简历表达」阶段，所有指标都要能复现并解释风险。
...
> 我在 `Quant Research Project` 中完成 `Quant简历表达` 阶段，能把知识点转化为可运行代码、可复现输出和可解释复盘。
