...
### A1. [maximum-product-of-three-numbers](https://leetcode.com/problems/maximum-product-of-three-numbers/)
...
### A2. [average-of-levels-in-binary-tree](https://leetcode.com/problems/average-of-levels-in-binary-tree/)
...
围绕 Mini Quant Research Framework，完成「最大回撤与净值曲线」阶段，所有指标都要能复现并解释风险。
...
> 我在 `Quant Research Project` 中完成 `最大回撤与净值曲线` 阶段，能把知识点转化为可运行代码、可复现输出和可解释复盘。
