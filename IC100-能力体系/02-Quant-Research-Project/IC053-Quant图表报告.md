...
### A1. [divide-two-integers](https://leetcode.com/problems/divide-two-integers/)
...
### A2. [next-permutation](https://leetcode.com/problems/next-permutation/)
...
围绕 Mini Quant Research Framework，完成「Quant图表报告」阶段，所有指标都要能复现并解释风险。
...
> 我在 `Quant Research Project` 中完成 `Quant图表报告` 阶段，能把知识点转化为可运行代码、可复现输出和可解释复盘。
