...
### A1. [rotate-image](https://leetcode.com/problems/rotate-image/)
...
### A2. [group-anagrams](https://leetcode.com/problems/group-anagrams/)
...
围绕 Mini Quant Research Framework，完成「Mini框架README」阶段，所有指标都要能复现并解释风险。
...
> 我在 `Quant Research Project` 中完成 `Mini框架README` 阶段，能把知识点转化为可运行代码、可复现输出和可解释复盘。
