...
### A1. [generate-parentheses](https://leetcode.com/problems/generate-parentheses/)
...
### A2. [swap-nodes-in-pairs](https://leetcode.com/problems/swap-nodes-in-pairs/)
...
围绕 Mini Quant Research Framework，完成「回测结果入库」阶段，所有指标都要能复现并解释风险。
...
> 我在 `Quant Research Project` 中完成 `回测结果入库` 阶段，能把知识点转化为可运行代码、可复现输出和可解释复盘。
