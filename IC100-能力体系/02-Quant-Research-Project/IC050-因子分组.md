...
### A1. [3sum-closest](https://leetcode.com/problems/3sum-closest/)
...
### A2. [letter-combinations-of-a-phone-number](https://leetcode.com/problems/letter-combinations-of-a-phone-number/)
...
围绕 Mini Quant Research Framework，完成「因子分组」阶段，所有指标都要能复现并解释风险。
...
> 我在 `Quant Research Project` 中完成 `因子分组` 阶段，能把知识点转化为可运行代码、可复现输出和可解释复盘。
