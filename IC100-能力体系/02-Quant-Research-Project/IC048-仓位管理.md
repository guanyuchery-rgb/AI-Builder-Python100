...
### A1. [string-to-integer-atoi](https://leetcode.com/problems/string-to-integer-atoi/)
...
### A2. [container-with-most-water](https://leetcode.com/problems/container-with-most-water/)
...
围绕 Mini Quant Research Framework，完成「仓位管理」阶段，所有指标都要能复现并解释风险。
...
> 我在 `Quant Research Project` 中完成 `仓位管理` 阶段，能把知识点转化为可运行代码、可复现输出和可解释复盘。
