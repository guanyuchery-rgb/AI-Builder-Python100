...
### A1. [distribute-candies](https://leetcode.com/problems/distribute-candies/)
...
### A2. [range-addition-ii](https://leetcode.com/problems/range-addition-ii/)
...
围绕 Mini Quant Research Framework，完成「收益率与波动率」阶段，所有指标都要能复现并解释风险。
...
> 我在 `Quant Research Project` 中完成 `收益率与波动率` 阶段，能把知识点转化为可运行代码、可复现输出和可解释复盘。
