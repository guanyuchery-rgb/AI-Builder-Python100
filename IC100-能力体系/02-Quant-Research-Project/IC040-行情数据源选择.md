...
### A1. [reverse-string-ii](https://leetcode.com/problems/reverse-string-ii/)
...
### A2. [diameter-of-binary-tree](https://leetcode.com/problems/diameter-of-binary-tree/)
...
围绕 Mini Quant Research Framework，完成「行情数据源选择」阶段，所有指标都要能复现并解释风险。
...
> 我在 `Quant Research Project` 中完成 `行情数据源选择` 阶段，能把知识点转化为可运行代码、可复现输出和可解释复盘。
