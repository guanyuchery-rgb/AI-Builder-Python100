...
### A1. [valid-parentheses](https://leetcode.com/problems/valid-parentheses/)
...
### A2. [merge-two-sorted-lists](https://leetcode.com/problems/merge-two-sorted-lists/)
...
把 Day 学到的「条件分支与输入验证」做成一个可运行小脚本，保留 `main.py`、`notes.md`、`errors.md`。
...
> 我在 `基础能力启动` 中完成 `条件分支与输入验证` 阶段，能把知识点转化为可运行代码、可复现输出和可解释复盘。
