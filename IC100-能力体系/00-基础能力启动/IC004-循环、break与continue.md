...
### A1. [remove-duplicates-from-sorted-array](https://leetcode.com/problems/remove-duplicates-from-sorted-array/)

- 难度：Easy
- 类型：双指针 / 数组
- 为什么做：这题训练 `双指针 / 数组` 的基本面试表达，同时帮助你把 Python 数据结构用熟。
...
### A2. [remove-element](https://leetcode.com/problems/remove-element/)
...
把 Day 学到的「循环、break与continue」做成一个可运行小脚本，保留 `main.py`、`notes.md`、`errors.md`。
...
> 我在 `基础能力启动` 中完成 `循环、break与continue` 阶段，能把知识点转化为可运行代码、可复现输出和可解释复盘。
