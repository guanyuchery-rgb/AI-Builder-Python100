...
### A1. [merge-sorted-array](https://leetcode.com/problems/merge-sorted-array/)
...
### A2. [binary-tree-inorder-traversal](https://leetcode.com/problems/binary-tree-inorder-traversal/)
...
把 Day 学到的「模块包与可复用脚本」做成一个可运行小脚本，保留 `main.py`、`notes.md`、`errors.md`。
...
> 我在 `基础能力启动` 中完成 `模块包与可复用脚本` 阶段，能把知识点转化为可运行代码、可复现输出和可解释复盘。
