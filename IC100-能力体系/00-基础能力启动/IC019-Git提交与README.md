...
### A1. [excel-sheet-column-number](https://leetcode.com/problems/excel-sheet-column-number/)
...
### A2. [reverse-bits](https://leetcode.com/problems/reverse-bits/)
...
把 Day 学到的「Git提交与README」做成一个可运行小脚本，保留 `main.py`、`notes.md`、`errors.md`。
...
> 我在 `基础能力启动` 中完成 `Git提交与README` 阶段，能把知识点转化为可运行代码、可复现输出和可解释复盘。
