...
### A1. [excel-sheet-column-title](https://leetcode.com/problems/excel-sheet-column-title/)
...
### A2. [majority-element](https://leetcode.com/problems/majority-element/)
...
把 Day 学到的「pytest最小测试」做成一个可运行小脚本，保留 `main.py`、`notes.md`、`errors.md`。
...
> 我在 `基础能力启动` 中完成 `pytest最小测试` 阶段，能把知识点转化为可运行代码、可复现输出和可解释复盘。
