...
### A1. [linked-list-cycle](https://leetcode.com/problems/linked-list-cycle/)
...
### A2. [binary-tree-preorder-traversal](https://leetcode.com/problems/binary-tree-preorder-traversal/)
...
把 Day 学到的「argparse命令行参数」做成一个可运行小脚本，保留 `main.py`、`notes.md`、`errors.md`。
...
> 我在 `基础能力启动` 中完成 `argparse命令行参数` 阶段，能把知识点转化为可运行代码、可复现输出和可解释复盘。
