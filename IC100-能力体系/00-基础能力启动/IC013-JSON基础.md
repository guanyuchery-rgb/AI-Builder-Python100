...
### A1. [path-sum](https://leetcode.com/problems/path-sum/)
...
### A2. [pascals-triangle](https://leetcode.com/problems/pascals-triangle/)
...
把 Day 学到的「JSON基础」做成一个可运行小脚本，保留 `main.py`、`notes.md`、`errors.md`。
...
> 我在 `基础能力启动` 中完成 `JSON基础` 阶段，能把知识点转化为可运行代码、可复现输出和可解释复盘。
