# IC012 - CSV DictReader DictWriter
...
### A1. [balanced-binary-tree](https://leetcode.com/problems/balanced-binary-tree/)
...
### A2. [minimum-depth-of-binary-tree](https://leetcode.com/problems/minimum-depth-of-binary-tree/)
...
把 Day 学到的「CSV DictReader DictWriter」做成一个可运行小脚本，保留 `main.py`、`notes.md`、`errors.md`。
...
> 我在 `基础能力启动` 中完成 `CSV DictReader DictWriter` 阶段，能把知识点转化为可运行代码、可复现输出和可解释复盘。
