...
### A1. [same-tree](https://leetcode.com/problems/same-tree/)
...
### A2. [symmetric-tree](https://leetcode.com/problems/symmetric-tree/)
...
把 Day 学到的「CLI学习记录器」做成一个可运行小脚本，保留 `main.py`、`notes.md`、`errors.md`。
...
> 我在 `基础能力启动` 中完成 `CLI学习记录器` 阶段，能把知识点转化为可运行代码、可复现输出和可解释复盘。
