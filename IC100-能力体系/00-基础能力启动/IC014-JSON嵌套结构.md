...
### A1. [pascals-triangle-ii](https://leetcode.com/problems/pascals-triangle-ii/)
...
### A2. [best-time-to-buy-and-sell-stock](https://leetcode.com/problems/best-time-to-buy-and-sell-stock/)
...
把 Day 学到的「JSON嵌套结构」做成一个可运行小脚本，保留 `main.py`、`notes.md`、`errors.md`。
...
> 我在 `基础能力启动` 中完成 `JSON嵌套结构` 阶段，能把知识点转化为可运行代码、可复现输出和可解释复盘。
