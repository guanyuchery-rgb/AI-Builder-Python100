...
### A1. [valid-palindrome](https://leetcode.com/problems/valid-palindrome/)
...
### A2. [single-number](https://leetcode.com/problems/single-number/)
...
把 Day 学到的「CSV vs JSON选择」做成一个可运行小脚本，保留 `main.py`、`notes.md`、`errors.md`。
...
> 我在 `基础能力启动` 中完成 `CSV vs JSON选择` 阶段，能把知识点转化为可运行代码、可复现输出和可解释复盘。
