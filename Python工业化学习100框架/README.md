...
每个 Day 的正文上限控制在 600 行以内。强化题必须提供具体 `main.py` 参考代码，并且代码要能直接运行、生成输出、支持替换输入和边界检查。
...
- 先跑通最小案例，再做带具体代码的今日强化题；Day06-Day20 先读「完全看不懂版」和「基础知识深讲」。
...
- IC020-IC100 负责工程挑战、GitHub 提交和四个求职项目沉淀。
- LeetCode 已独立到 [../leetcode（hot code）300](<../leetcode（hot code）300/README.md>)，不再夹在 Python100 或 IC 每天任务里。
