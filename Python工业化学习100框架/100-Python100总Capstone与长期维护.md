# Day100 - Python100总Capstone与长期维护

学习定位：把 Python100 收口为长期维护资产。
...
## 核心知识点：Portfolio and Maintenance
...
一个和“Python100总Capstone与长期维护”相关的可复用函数、脚本或项目模块。
